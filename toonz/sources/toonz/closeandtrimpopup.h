...
#ifndef CLOSE_AND_TRIM_POPUP_H
#define CLOSE_AND_TRIM_POPUP_H
...
//*****************************************************************************
//    Close And Trim Popup  declaration
//*****************************************************************************

class CloseAndTrimPopup final : public DVGui::Dialog {
  Q_OBJECT
...
private:
  ...
  //DVGui::MeasuredDoubleField *m_vectorGapDistance; //!< Maximum Gap Distance for Vector Level
  DVGui::IntField *m_vectorGapDistance;
  //DVGui::MeasuredDoubleField *m_vectorGapDistanceValue;
